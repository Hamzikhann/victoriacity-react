...
const Editproject = ({ project, isShowEditProjectModal, setIsShowEditProjectModal, getprojectById }) => {
						...
						<div className="modal-body">
							<Formik
								...
								onSubmit={async (values, { setSubmitting }) => {
									...
									try {
										setloading(true);
										const res = await Axios.put(baseApiUrl + `/project/update?id=${values.id}`, formData);
