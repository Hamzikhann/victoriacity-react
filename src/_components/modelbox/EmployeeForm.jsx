									...
									<div className="row">
										<div className="col-sm-6 ">
											<div className="form-group">
												<span className="text-lg border-bottom border-2 border-dark mb-3">Personal Information: </span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
										...
										<div className="col-sm-6 ">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.full_name && touched.full_name && errors.full_name}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.father_name && touched.father_name && errors.father_name}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
										...
										<div className="col-sm-6">
											<div className="form-group">
												...
												Single
												<br />
												<span className="error">{errors.is_married && touched.is_married && errors.is_married}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
										...
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.employee_id && touched.employee_id && errors.employee_id}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												<Field as="select" className="form-control" name="designation">
													<option value="">-</option>
													{designations && designations.map((item) => <option value={item.id}>{item.title}</option>)}
												</Field>
										...
										<div className="col-sm-6">
											<div className="form-group">
												...
												{/* <input className="form-control" type="text" /> */}
												<Field as="select" className="form-control" name="projects">
													<option value="">-</option>
													{projects && projects.map((item) => <option value={item.id}>{item.name}</option>)}
												</Field>
											</div>
										</div>
										...
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">
													{errors.basic_salary && touched.basic_salary && errors.basic_salary}
												</span>
											</div>
										</div>
