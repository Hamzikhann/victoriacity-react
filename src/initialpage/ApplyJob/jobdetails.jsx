							...
							<div className="job-info job-widget">
								...
								<ul className="job-post-det">
									<li>
										...
										<span className="text-blue">{jobDetails && jobDetails.startdate}</span>
									</li>
									...
									<li>
										...
										<span className="text-blue">{jobDetails && jobDetails.applicants}</span>
									</li>
						...
						<div className="col-md-4">
							<div className="job-det-info job-widget">
								...
								<div className="info-list">
									...
									<h5>Salary</h5>
									<p>
										${jobDetails && jobDetails.salaryFrom} - ${jobDetails && jobDetails.salaryTo}
									</p>
								</div>
								<div className="info-list">
									<span>
							...
							{({
								...
								<form onSubmit={handleSubmit}>
									...
									<div className="form-group">
										...
										/>
										<span style={{ color: "red" }} className="error">
											{errors.current_salary && touched.current_salary && errors.current_salary}
										</span>
									</div>
									...
									<div className="form-group">
										...
										/>
										<span style={{ color: "red" }} className="error">
											{errors.expected_salary && touched.expected_salary && errors.expected_salary}
										</span>
									</div>
									...
									<div className="form-group">
										...
										/>
										<span style={{ color: "red" }} className="error">
											{errors.cover_letter && touched.cover_letter && errors.cover_letter}
										</span>
									</div>
									<div className="form-group">
