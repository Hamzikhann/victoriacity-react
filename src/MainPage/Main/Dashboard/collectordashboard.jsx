	...
	return (
		<>
			...
			<div className="page-wrapper">
				<Helmet>
					<title>Collector Dashboard - Sheranwala</title>
					...
					<div className="page-header">
						<div className="row">
							<div className="col-sm-12">
								<h3 className="page-title">Collector Dashboard</h3>
								<ul className="breadcrumb">
									<li className="breadcrumb-item">
										<Link to="/app/main/dashboard">Dashboard</Link>
									</li>
									<li className="breadcrumb-item">Collector</li>
									<li className="breadcrumb-item active">Collector Dashboard</li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div className="card dash-widget">
								<div className="card-body">
									...
									<div className="dash-widget-info">
										...
										<span>Collected Files (Today)</span>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="card dash-widget">
								<div className="card-body">
									...
									<div className="dash-widget-info">
										...
										<span>Collected Files (Yesterday)</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div className="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div className="card dash-widget">
								<div className="card-body">
									...
									<div className="dash-widget-info">
										<h3>{jobsData && jobsData.totalJobCanidate.count}</h3>
										<span>Collected Files (Last 3 Days)</span>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="card dash-widget">
								<div className="card-body">
									...
									<div className="dash-widget-info">
										...
										<span>Collected Files (Last 7 Days)</span>
									</div>
								</div>
							</div>
						</div>
                       ...
                       <div className="card-body">
                         ...
                         <Line data={data} />
								...
								<div className="col-md-12 ">
									<div className="card flex-fill">
										<div className="card-body">
											<h3 className="card-title text-center">Latest Collected Files</h3>
