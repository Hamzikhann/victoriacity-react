      ...
      <div className="content container-fluid">
        ...
        <div className="row">
          {dashboard[0]?.projectData?.map((project, index) => (
            <>
              ...
              <div key={index} className="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                <Link
                  to={`/app/accounts/income-transactions/${project.projectId}`}
                >
              ...
              <div key={index} className="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                <Link
                  to={`/app/accounts/expense-transactions/${project.projectId}`}
                >
                  <div className="card dash-widget">
                    <div className="card-body">
                      <span className="dash-widget-icon">
          ...
          <div className="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <Link
                  to={`/app/accounts/liabilitypartner`}
                >
              <div className="card dash-widget">
                <div className="card-body">
                  <span className="dash-widget-icon">
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-4">
            <Link
                  to={`/app/accounts/withdrawalpartner`}
                >
              <div className="card dash-widget">
                <div className="card-body">
                  <span className="dash-widget-icon">
