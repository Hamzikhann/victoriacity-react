...
const getDashboardData = () => {
  Axios.get(baseApiUrl + "dashboard/data")
    .then((res) => {
      ...
      return (
        ...
        <div className="content container-fluid">
              ...
              <div className="card dash-widget">
                <div className="card-body">
                  ...
                  <div className="dash-widget-info">
                    <h3>{dashboard ? dashboard.project: 0}</h3>
                    <span>Projects</span>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-3">
              <div className="card dash-widget">
                <div className="card-body">
                  ...
                  <div className="dash-widget-info">
                    <h3>{dashboard ? dashboard.customer: 0}</h3>
                    <span>Clients</span>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-3">
              <div className="card dash-widget">
                <div className="card-body">
                  ...
                  <div className="dash-widget-info">
                    <h3>{dashboard ? dashboard.openJobs: 0}</h3>
                    <span>Open Jobs</span>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 col-sm-6 col-lg-6 col-xl-3">
              <div className="card dash-widget">
                <div className="card-body">
                  ...
                  <div className="dash-widget-info">
                  <h3>{dashboard ? dashboard.employee: 0}</h3>
                    <span>Employees</span>
                  </div>
                </div>
              </div>
          ...
          <div className="row" style={{display: "none"}}>
            ...
            <div className="col-md-12 col-lg-6 col-xl-4 d-flex" style={{display: "none"}}>
          ...
          <div className="row">
            <div className="col-md-6 d-flex">
              <div className="card card-table flex-fill">
                <div className="card-header">
                  <h3 className="card-title mb-0">Recent Clients</h3>
                </div>
                <div className="card-body">
                  <div className="table-responsive">
                    <table className="table custom-table mb-0">
                      ...
                      {dashboard && dashboard.customers && dashboard.customers.map((item) => (
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="#" className="avatar"><img alt="" src={Avatar_19} /></a>
                                <Link to = "/app/profile/client-profile">{item.fullName} <span></span></Link>
                              </h2>
                            </td>
                            <td>{item.email}</td>
                            <td>
                  ...
                  <div className="table-responsive">
                    <table className="table custom-table mb-0">
                      ...
                      <tbody>
                        ...
                        {dashboard && dashboard.projects && dashboard.projects.map((item) => (
                          <tr>
                            <td>
                              <h2><Link to = "/app/projects/projects-view">{item.name}</Link></h2>
                              <small className="block text-ellipsis">
                                <span>{item.startDate}</span> <span className="text-muted">Start Date, </span>
                                <span>{item.endDate}</span> <span className="text-muted">End Date</span>
                              </small>
                            </td>
