...
const EmployeeDashboard = () => {
    ...
    const getEmployeeTasksById = () => {
        Axios.get(baseApiUrl + `employee/projectTask/list?id=${object?.employee?.id}`).then((res) => {
            // console.log(res.data.ProjectTask[0], 'employee');
            setEmployee(res.data.ProjectTask);
            setTotalTasks(res.data.taskCount);
                        ...
                        <div className="col-md-12">
                            <div className="welcome-box">
                                ...
                                <div className="welcome-det">
                                    <h3>Welcome, {object?.employee?.fullName}</h3>
                                    <p>{DATE + ` ` + monthNames[MONTH] + ` ` + YEAR}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <a href="#" className="dash-card">
                                                <div className="dash-card-container">
                                                    ...
                                                    <div className="dash-card-content">
                                                        <Link to={`/tasks/tasks?id=` + employee.id} key={employee.id}>
                                                            <p>{employee?.name}</p>
                                                        </Link>
                                                    </div>
                                                    <div className="dash-card-avatars">
                                                        <div className="e-avatar"><img src={employee?.project?.image}
                                                                                       alt=""
                                                                                       onError={({currentTarget}) => {
                                                                                           currentTarget.onerror = null; // prevents looping
                                                                                           currentTarget.src =
