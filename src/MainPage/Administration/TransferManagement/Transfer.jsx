...
const Transfer = () => {
	...
	const columns = [
		...
		// },
		{
			...
			sorter: (a, b) => a.Secondary_Member_ID.length - b.Secondary_Member_ID.length
			// render: (text) => {
			//      <span>{text?.Name}</span>
			// },
		},
				...
				<div className="page-header">
					<div className="row align-items-center">
						...
						<div className="col-auto float-end ml-auto">
							<p className="btn add-btn button" onClick={() => setIsShowFileTransferModal(true)}>
						...
						<div className="modal-body">
							<Formik
								...
								onSubmit={async (values, { setSubmitting }) => {
									...
									myFormData.append("Booking_Temp", JSON.stringify(values.Booking_Temp));
									...
									myFormData.append("Secondary_Member_ID", values.Sec_MEM_ID.value);
												...
												<div className="col-sm-6">
													<div className="form-group">
														...
														<span className="error">
															{errors.Sec_MEM_ID && touched.Sec_MEM_ID && errors.Sec_MEM_ID}
														</span>
													</div>
												</div>
												{/* <div className="col-sm-6">
                              ...
                              errors.Member_Adress}
												...
												<div className="col-sm-6">
													<div className="form-group">
														...
														/>
														<span className="error">
															{errors.Rebate_Amt && touched.Rebate_Amt && errors.Rebate_Amt}
														</span>
													</div>
												</div>
