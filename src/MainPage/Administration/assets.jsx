					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.post(baseApiUrl + "asset/add", formData);
									if (res.data.status == 200) {
										getAllAssets();
										toast.success(res.data.message);
										setloading(false);
										...
										<div className="row">
											<div className="col-md-6">
												<div className="form-group">
													...
													/>
													{errors.name && touched.name && <span className="text-danger text-sm">{errors.name}</span>}
												</div>
											</div>
											<div className="col-md-6">
												<div className="form-group">
													...
													{errors.type && touched.type && <span className="text-danger text-sm">{errors.type}</span>}
												</div>
											</div>
										</div>
										...
										<div className="row">
											<div className="col-md-6">
												<div className="form-group">
													...
													/>
													{errors.model && touched.model && <span className="text-danger text-sm">{errors.model}</span>}
												</div>
											</div>
											<div className="col-md-6">
												<div className="form-group">
													...
													{errors.brand && touched.brand && <span className="text-danger text-sm">{errors.brand}</span>}
												</div>
											</div>
										</div>
										<div className="row">
											<div className="col-md-6">
												<div className="form-group">
													...
													{errors.addedDate && touched.addedDate && (
														<span className="text-danger text-sm">{errors.addedDate}</span>
													)}
												</div>
											</div>
											<div className="col-md-6">
												<div className="form-group">
													...
													{errors.expiryDate && touched.expiryDate && (
														<span className="text-danger text-sm">{errors.expiryDate}</span>
													)}
												</div>
											</div>
										</div>
											...
											<div className="col-md-6 ">
												<div className="form-group">
													...
													{errors.quantity && touched.quantity && (
														<span className="text-danger text-sm">{errors.quantity}</span>
													)}
												</div>
											</div>
											<div className="col-md-12">
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.put(baseApiUrl + `asset/update?id=${query}`, formData);
									if (res.data.status == 200) {
										getAllAssets();
										toast.success(res.data.message);
										setloading(false);
								...
								<div className="row">
									<div className="col-6">
										<button
											...
											type="submit"
											onClick={() => deleteAssetsById(query)}
										>
											Delete
										</button>
									</div>
