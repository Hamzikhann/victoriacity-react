...
const Booking = () => {
	...
	const [isShowDevelopmentCharges, setIsShowDevelopmentCharges] = useState(false);
	...
	const columns = [
		...
		},
		{
			...
			sorter: (a, b) => a?.SecondMember?.BuyerName.length - b?.SecondMember?.BuyerName.length
		},
		{
			title: "Unit Plot No",
			dataIndex: "Unit_ID",
			...
			render: (text, record) => {
				const plotNo = text ? unit.find((item) => item.Unit_ID === text)?.value : "";
		...
		},
		{
			...
			sorter: (a, b) => a.TotalRemainNet_Amt.length - b.TotalRemainNet_Amt.length
		},
		{
		...
		},
		{
			...
			sorter: (a, b) => a.Total_Payable_Net_Amt.length - b.Total_Payable_Net_Amt.length
		},
		{
			title: "Ballot Amount",
...

		{
			...
			sorter: (a, b) => a.ByAnnual_TimePeriod.length - b.ByAnnual_TimePeriod.length
		},
		{
	...
	const getAllMember = () => {
		Axios.get(baseApiUrl + "member/list").then((res) => {
			res.data.member.map((item) => {
				setMember((prev) => [...prev, { label: item.BuyerName, value: item.MEMBER_ID }]);
				// setMember([]);
						...
						{successAlert && (
							<div className="modal-body">
								<Alert variant="success" onClose={() => setSuccessAlert(false)} dismissible>
									...
									<a href="#" style={{ textDecoration: "underline", color: "green" }} onClick={AckLetterPdf}>
										Click here
									</a>{" "}
									to download Acknowledgment Letter.{" "}
									<a href="#" style={{ textDecoration: "underline", color: "green" }} onClick={PaymentPlanPdf}>
										Click here
									</a>{" "}
						...
						<div className="modal-body">
							<Formik
								...
								onSubmit={async (values, { setSubmitting }) => {
									...
									try {
										setloading(true);
										const res = await Axios.post(baseApiUrl + `booking/add`, formData);
										...
										<div className="row">
											<div className="col-sm-6">
												<div className="form-group">
													...
													<input className="form-control" type="text" value={values.Reg_Code_Disply} disabled={true} />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
											...
											<div className="col-sm-6">
												<div className="form-group">
													...
													<input className="form-control" type="Text" value={values.Total_Amt} disabled={true} />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													<label>Advance Amount</label>
													<input className="form-control" type="Text" value={values.Advance_Amt} disabled={true} />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
											...
											<div className="col-sm-6">
												<div className="form-group">
													...
													<input className="form-control" type="Text" value={values.Ballot_Amt} disabled={true} />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													<label>Possession Amount</label>
													<input className="form-control" type="Text" value={values.Possession_Amt} disabled={true} />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													<label>Annual Charges</label>
													<input className="form-control" type="Text" value={values.ByAnnual_Charges} disabled={true} />
												</div>
											</div>
											...
											<div className="col-sm-6">
												<div className="form-group">
													...
													<Select options={unitNatureType} value={values.NType_ID} isDisabled={true} />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group ">
													<div className="justify-content-between d-flex">
														...
														<div>
															<a onClick={handleClearButtonClick} style={{ color: "blue", fontSize: "12px" }}>
																Clear
															</a>
														</div>
													</div>
                              ...
                              Clear
											...
											<div className="col-sm-6">
												<div className="form-group">
													<div className="justify-content-between d-flex">
														<label>
															Select Second Member <span className="text-danger">*</span>
														</label>
														<div>
                              ...
                              errors.Member_Adress}
											...
											<div className="col-sm-6">
												<div className="form-group">
													...
													/>
													<span className="error">{errors.Rebate_Amt && touched.Rebate_Amt && errors.Rebate_Amt}</span>
												</div>
											</div>
						...
						<Formik
							...
							validate={(values) => {
								...
								if (!values.Total_Payable_Net_Amt) {
									errors.Total_Payable_Net_Amt = "Total_Payable_Net_Amt is required";
								}
								...
								if (!values.ByAnnual_TimePeriod) {
									errors.ByAnnual_TimePeriod = "ByAnnual_TimePeriod is required";
								}
									...
									<div className="row">
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.BK_Reg_Code && touched.BK_Reg_Code && errors.BK_Reg_Code}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.BK_Date && touched.BK_Date && errors.BK_Date}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.SRForm_No && touched.SRForm_No && errors.SRForm_No}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.Form_Code && touched.Form_Code && errors.Form_Code}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
										...
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.BKType_ID && touched.BKType_ID && errors.BKType_ID}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												<label>
													CommissionAgentID <span className="text-danger"></span>
												</label>
												<input
												...
												/>
												<span className="error">
													{errors.CommissionAgentID && touched.CommissionAgentID && errors.CommissionAgentID}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.PMID && touched.PMID && errors.PMID}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.CHQUE_DATE && touched.CHQUE_DATE && errors.CHQUE_DATE}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.CHEQUE_NO && touched.CHEQUE_NO && errors.CHEQUE_NO}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">
													{errors.INSTRUMENT_NO && touched.INSTRUMENT_NO && errors.INSTRUMENT_NO}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.Total_Amt && touched.Total_Amt && errors.Total_Amt}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.Advance_Amt && touched.Advance_Amt && errors.Advance_Amt}</span>
											</div>
										</div>
										...
										<div className="col-sm-6">
											<div className="form-group">
												<label>
													TotalRemainNet Amount <span className="text-danger">*</span>
												</label>
												<input
													value={values.TotalRemainNet_Amt}
													className="form-control"
												...
												/>
												<span className="error">
													{errors.TotalRemainNet_Amt && touched.TotalRemainNet_Amt && errors.TotalRemainNet_Amt}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">
													{errors.Discount_Amt && touched.Discount_Amt && errors.Discount_Amt}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												<label>
													Total Payable Net Amount <span className="text-danger">*</span>
												</label>
												<input
													...
													type="Text"
													onChange={(e) => {
														setFieldValue("Total_Payable_Net_Amt", e.target.value);
													}}
												/>
												<span className="error">
										...
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.Ballot_Amt && touched.Ballot_Amt && errors.Ballot_Amt}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												<label>
													Possession Amount <span className="text-danger">*</span>
												</label>
												<input
												...
												/>
												<span className="error">
													{errors.Possession_Amt && touched.Possession_Amt && errors.Possession_Amt}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">
													{errors.ByAnnual_Charges && touched.ByAnnual_Charges && errors.ByAnnual_Charges}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												<label>
													Annual TimePeriod <span className="text-danger">*</span>
												</label>
												<input
													...
													type="Text"
													onChange={(e) => {
														setFieldValue("ByAnnual_TimePeriod", e.target.value);
													}}
												/>
												<span className="error">
													{errors.ByAnnual_TimePeriod && touched.ByAnnual_TimePeriod && errors.ByAnnual_TimePeriod}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">
													{errors.InstallmentAmount && touched.InstallmentAmount && errors.InstallmentAmount}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.Dealer_ID && touched.Dealer_ID && errors.Dealer_ID}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												<label>
													No Of Installments <span className="text-danger">*</span>
												</label>
												<input
													value={values.No_Of_Installments}
													className="form-control"
												...
												/>
												<span className="error">
													{errors.No_Of_Installments && touched.No_Of_Installments && errors.No_Of_Installments}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.Plan_Years && touched.Plan_Years && errors.Plan_Years}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.IsCompPaid && touched.IsCompPaid && errors.IsCompPaid}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.IsDeleted && touched.IsDeleted && errors.IsDeleted}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">
													{errors.AdminVarified && touched.AdminVarified && errors.AdminVarified}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">
													{errors.Discount_PerAge && touched.Discount_PerAge && errors.Discount_PerAge}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">{errors.USER_ID && touched.USER_ID && errors.USER_ID}</span>
											</div>
										</div>
										<div className="col-sm-6">
											<div className="form-group">
												...
												/>
												<span className="error">
													{errors.Reg_Code_Disply && touched.Reg_Code_Disply && errors.Reg_Code_Disply}
												</span>
											</div>
										</div>
										<div className="col-sm-6">
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.put(baseApiUrl + `booking/update/status?id=${query}`, formData);
									if (res.data.status == 200) {
										getAllBooking(1);
										setPage(page);
										toast.success(res.data.message);
