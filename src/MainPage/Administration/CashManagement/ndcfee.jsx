...
const Ndcfee = () => {
  ...
  const [isShowDoubleObjectModal, setIsShowisShowDoubleObjectModal] =
    useState(false);
  ...
  const [isShowMemberNomineeModal, setIsShowMemberNomineeModal] =
    useState(false);
  const [isShowEditMemberNomineeModal, setIsShowEditMemberNomineeModal] =
    useState(false);
  ...
  const columns = [
    {
      title: "Actions",
      render: (text, record) => {
        console.log("TTTTTTTTTTTTTTTTTT", record);
        // console.log(
        //   "iiiiiiiiiiiiiii",
        //   text.relation,
        ...
        return (
          <div className="dropdown dropdown-action text-end">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              {(text.status == 4 && userRole?.slug == "colonel") && (
                <>
                  <Link
                    to="#"
                    ...
                    onClick={async () => {
                      setSelectedId(record.TRSR_ID);
                      // handleRegButtonClick(record.Booking.Reg_Code_Disply);

                      // setIsShowFileTransferModal(true);

                      const formData = {
                        status: 5,
                      };
                      const res = await Axios.put(
                        baseApiUrl + `ndc/update/status?id=${record.TRSR_ID}`,
                        formData
                      );
                  ...
                  >
                    <i className="fa fa-solid fa-check m-r-5" /> Verify
                  </Link>
                </>
              )}
              {(userRole?.slug == "csr_manager" ||
                userRole?.name == "Admin") && (
                <>
                {(text.status == 4 || text.status == 5) && (
                  ...
                  <Link
                    ...
                    onClick={() => {
                      setPDF("");
                      setTimeout(() => {
                        transferEventPdf(record.TRSR_ID);
                      }, 2000);
                    }}
                  >
                    <i className="fa fa-download m-r-5" /> Transfer Event
                  </Link>
                  <Link
                    to="#"
                    className="dropdown-item"
                    ...
                    onClick={() => {
                      setPDF("");
                      setTimeout(() => {
                        transferLetter(record.TRSR_ID);
                      }, 2000);
                    }}
                  >
                    <i className="fa fa-download m-r-5" /> Transfer Letter
                  </Link>
                  ...
                  <Link
                    ...
                    onClick={() => {
                      setPDF("");
                      setTimeout(() => {
                        NdcRecipt(record.BK_ID, record.TRSR_ID, "ndc_fee");
                      }, 2000);
                    }}
                  >
                    <i className="fa fa-download m-r-5" /> NDC Fee Reciept
                  </Link>
                  <Link
                    to="#"
                    className="dropdown-item"
                    ...
                    onClick={() => {
                      setPDF("");
                      setTimeout(() => {
                        NdcRecipt(record.BK_ID, record.TRSR_ID, "transfer_fee");
                      }, 2000);
                    }}
                  >
                    <i className="fa fa-download m-r-5" /> Transfer Fee
                  </Link>
                  ...
                  <Link
                    ...
                    onClick={() => {
                      setPDF("");
                      setTimeout(() => {
                        NdcRecipt(record.BK_ID,record.TRSR_ID, "transfer_tax");
                      }, 2000);
                    }}
                  >
                    <i className="fa fa-download m-r-5" /> Transfer Tax
                  </Link>
                </>
              )}

              {userRole.slug == 'file_collector' && text.status == 4 &&  <>
                  <Link
                    to="#"
                    className="dropdown-item"
                    // data-bs-toggle="modal"
              ...
              {text.status == 1 && (
                ...
                >
                  <i className="fa fa-download m-r-5" /> Dispatch To Accounts
                  Depart
                </Link>
              )}

              {text.status == 2 && (userRole?.slug == "accounts" || userRole?.slug == "cashier") && (
                <>
                  <Link
                    to="#"
                    className="dropdown-item"
                  ...
                  >
                    <i className="fa fa-download m-r-5" /> Dispatch To CSR
                    Depart
                  </Link>
                  {record?.BUYER_MEMBER_ID ? (
                    // If BUYER_MEMBER_ID exists, show "Edit Member" link
                    <Link
                      to="/"
                      className="dropdown-item"
                      data-bs-toggle="modal"
                      data-bs-target="#edit_member"
                      onClick={() => {
                        setQuery(record.TRSR_ID);
                        const MemberData = getAllMembersbyId(
                          record.BUYER_MEMBER_ID
                        );
                        setIsShowEditMemberModal(true);
                      }}
                    >
                      <i className="fa fa-pencil m-r-5" /> Edit Member
                    </Link>
                  ) : (
                    // If BUYER_MEMBER_ID does not exist, show "Add Member" link
                    <Link
                      to="#"
                      className="dropdown-item"
                      onClick={() => {
                        ...
                        setShowMemberText("Add Member");
                        setMemberType(1)
                      }}
                    >
                      <i className="fa fa-plus" /> Member
                    </Link>
                  )}
                  {record?.BUYER_MEMBER_NOMINEE_ID ? (
                    <Link
                      to="/"
                      className="dropdown-item"
                      data-bs-toggle="modal"
                      ...
                      onClick={() => {
                        setQuery(text.TRSR_ID);
                         getAllNomineebyId(
                          record.BUYER_MEMBER_NOMINEE_ID
                        );
                        setIsShowEditMemberNomineeModal(true);
                      }}
                    >
                      <i className="fa fa-pencil m-r-5" /> Edit Nominee
                    </Link>
                  ) : (
                    <Link
                      to="#"
                      ...
                      onClick={async () => {
                        setSelectedId(record);
                        // handleRegButtonClick(record.Booking.Reg_ Code_Disply)
                        setNomineeInitialValues((prev) => ({
                          ...prev,
                          MEMBER_ID: memberList.find(
                            (item) => item.id == record.BUYER_MEMBER_ID
                          ),
                        }));
                        setIsShowMemberNomineeModal(true);
                    ...
                    >
                      <i className="fa fa-plus" /> Nominee
                    </Link>
                  )}
                  {record.BUYER_SECOND_MEMBER_ID ? (
                    <Link
                      to="/"
                      className="dropdown-item"
                      data-bs-toggle="modal"
                    ...
                    >
                      <i className="fa fa-pencil m-r-5" /> Edit Second Member
                    </Link>
                  ):(
                    <Link
                      to="#"
                      ...
                      onClick={async () => {
                        setSelectedId(record.TRSR_ID);
                        setIsShowMemberModal(true);
                        setShowMemberText("Add Second Member");
                        setMemberType(2)

                      }}
                    >
                      <i className="fa fa-plus" /> Second Member
                    </Link>
                  )}
                </>
              )}
              ...
              {text.status == 3 && !record.ASSIGN_BY && (
                <Link
                  to="#"
                  className="dropdown-item"
                  // data-bs-toggle="modal"
                  // data-bs-target="#delete_member"
                  onClick={async () => {
                    // console.log("ZZZZZZZZZZZZZZZZZZZZZ", record)
                    setSelectedId(record);
                    // console.log("OOOOOOOOOOOOOOOOOOOOOOOOOOOO",record)
                    // handleRegButtonClick(record.Booking.Reg_Code_Disply);
                    // handleRegButtonClick(record.VOUCHER_ID);
                ...
                >
                  <i className="fa fa-tasks m-r-5" /> Assign To User
                </Link>
              )}
              {text.status == 3 && userRole.slug !== 'file_collector' && (
                <Link
                  to="#"
                  className="dropdown-item"
                  // data-bs-toggle="modal"
                ...
                >
                  <i className="fa fa-tasks m-r-5" /> Return to Accounts
                </Link>
              )}
              {text.status == 3 && (
                <Link
                  ...
                  onClick={async () => {
                    ...
                    getAllMembersbyId(record.BUYER_MEMBER_ID);
                    record.BUYER_SECOND_MEMBER_ID && getSecondMembersbyId(record.BUYER_SECOND_MEMBER_ID, true);
                    getAllNomineebyId(record.BUYER_MEMBER_NOMINEE_ID)
                    handleRegButtonClick(record.Booking.Reg_Code_Disply);
                // console.log("QQQQQQQQQQQQQQQQQQWWWWWWWWWWWWWWWWW", record)
                ...
                >
                  <i className="fa fa-exchange m-r-5" /> Transfer
                </Link>
              )}
            </div>
          </div>
  ...
  const getAllMembersbyId = (id) => {
    ...
    Axios.get(baseApiUrl + `/member/id/list?id=${id}`)
      .then((res) => {
          ...
          setMemberInitialValues({ ...res.data.Member, Relation: options.find((item)=> item.value == res.data.Member.Relation ) });
  ...
  const getSecondMembersbyId = (id) => {
    ...
    Axios.get(baseApiUrl + `/member/id/list?id=${id}`)
      .then((res) => {
          ...
          setSMemberInitialValues({ ...res.data.Member, Relation: options.find((item)=> item.value == res.data.Member.Relation ) })
  ...
  const getAllNomineebyId = (id) => {
    ...
    Axios.get(baseApiUrl + `/nominee/id/list?id=${id}`)
      .then((res) => {
        setNomineeInitialValues({ ...res.data.MemNominee ,NomineeRealtion: options1.find((item)=> item.value == res.data?.MemNominee?.NomineeRealtion ), MEMBER_ID: {value: res.data.MemNominee.Member.MEMBER_ID, label: `${res.data.MemNominee.Member.BuyerName} (${res.data.MemNominee.Member.BuyerCNIC})`}  });
      })
      .catch((err) => console.log(err.response.data));
  };
  ...
  const NdcRecipt = (BK_ID, trsr_id, receipt_Head) => {
    Axios.get(
      baseApiUrl + `transaction/file?BK_ID=${BK_ID}&RECEIPT_HEAD=${receipt_Head}&TRSR_ID=${trsr_id}`
    )
      .then((res) => {
        // getAllBooking(1);
        if (res.data.status == 200) {
  ...
  return (
    <div className="page-wrapper">
          ...
          <div className="modal-body">
            <Formik
              initialValues={{
                TRSR_ID: selectedId,
                MEMBER_ID: memberList.find(
                  (item) => item.id == selectedId?.BUYER_MEMBER_ID
                ),
                MN_ID: nominee.find(
                  (item) => item.id == selectedId?.BUYER_MEMBER_NOMINEE_ID
                ),
                Sec_MEM_ID: memberList.find(
                  (item) => item.id == selectedId?.BUYER_SECOND_MEMBER_ID
                ),
              }}
              validate={(values) => {
                const errors = {};
            ...
            <div className="modal-body">
              ...
              enableReinitialize={true}
                ...
                onSubmit={async (values, { setSubmitting,setErrors }) => {
                  ...
                  myFormData.append(
                    "BUYER_MEMBER_ID",
                    selectedId.BUYER_MEMBER_ID
                  );
                  myFormData.append(
                    "BUYER_MEMBER_NOMINEE_ID",
                    selectedId.BUYER_MEMBER_NOMINEE_ID
                  );
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-6">
                          <div className="form-group">
                            ...
                            />
                            <span className="error">
                              {errors.RelationToOwner &&
                                touched.RelationToOwner &&
                                errors.RelationToOwner}
                            </span>
                          </div>
                        </div>
            ...
            <Formik
              ...
              validate={(values) => {
                ...
                if (!values.BuyerCNIC) {
                  ...
                  !/^[0-9+]{5}-[0-9+]{7}-[0-9]{1}$/i.test(values.BuyerCNIC)
                ) {
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-6">
                        <div className="form-group">
                          ...
                          />
                          <span className="error">
                            {errors.BuyerSecondContact &&
                              touched.BuyerSecondContact &&
                              errors.BuyerSecondContact}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="col-sm-12">
                        <div className="form-group">
                          ...
                          ></textarea>
                          <span className="error">
                            {errors.PermanantAddress &&
                              touched.PermanantAddress &&
                              errors.PermanantAddress}
                          </span>
                        </div>
                      </div>
            ...
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                try {
                  setloading(true);
                  const res = await Axios.put(
                    baseApiUrl + `member/update?id=${values.MEMBER_ID}`,
                    formData
                  );
                  if (res.data.status == 200) {
                    getAllNDCRequests(1);
            ...
            <Formik
              ...
              validate={(values) => {
                ...
                if (!values.NomineeCNIC) {
                  ...
                  !/^[0-9+]{5}-[0-9+]{7}-[0-9]{1}$/i.test(values.NomineeCNIC)
                ) {
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-6">
                        <div className="form-group">
                          ...
                          />
                          <span className="error">
                            {errors.NomineeFatherName &&
                              touched.NomineeFatherName &&
                              errors.NomineeFatherName}
                          </span>
                        </div>
                      </div>
                      <div className="col-sm-6">
                        <div className="form-group">
                          ...
                          />
                          <span className="error">
                            {errors.NomineeRealtion &&
                              touched.NomineeRealtion &&
                              errors.NomineeRealtion}
                          </span>
                        </div>
                      </div>
      ...
      <Modal
        show={isShowEditMemberNomineeModal}
            ...
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                try {
                  setloading(true);
                  const res = await Axios.put(
                    baseApiUrl + `nominee/update?id=${values.MN_ID}`,
                    formData
                  );
                  if (res.data.status == 200) {
                    getAllNDCRequests(1);
