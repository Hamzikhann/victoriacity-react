            ...
            <div className="col-auto float-end ml-auto">
              {loading ? (
                ...
                >
                  ...
                  <>
                   {currentUser && currentUser.role === 'Admin' && <button type="button" className="btn add-btn button" disabled={selectedRowKeys.length==0?true:false} onClick={handleSubmitVerify}>
                      <i className="" /> Verify
                    </button>}

                      <button type="button" disabled={selectedRowKeys.length==0?true:false} className="btn add-btn button" style={{marginRight: 10}}
                          onClick={() => {
                              setPDF("");
                              setTimeout(() => {
                                  UnverifiedTransactionReciept();
                      ...
                      <button type="button" className="btn add-btn button" style={{marginRight: 10}}
                          onClick={() => {
                              setPDF("");
                              setTimeout(() => {
