...
const CandidateList = () => {
  ...
  const getAllCandidates = () => {
    Axios.get(baseApiUrl + "/api/user/job/candidates/list")
      .then((res) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "firstName",
      render: (text, record) => (
        <Link to={`/app/administrator/job-details?id=${record.id}`}>{text}</Link>
      ),
  ...
  return (
    <>
      ...
      <div className="page-wrapper">
        <Helmet>
          <title>Candidates List - Sheranwala Developers</title>
