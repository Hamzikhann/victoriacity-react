...
const Offerapproval = () => {
  ...
  useEffect(() => {
    axios
      .get(baseApiUrl + "/api/user/job/candidates/job/offer-list/list")
      .then((res) => setData(res.data.job_candidates)
      );
  }, []);
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) =>
        (<span>{record.jobs.jobtitle}</span>)
    },
    {
      title: 'Job Type',
      dataIndex: 'jobtype',
