...
const AppliedCandidate = () => {
	...
	const [baseApiUrl, setBaseApiUrl] = useState(baseApiUrl + "/api/");
	...
	const getAllJobCandidates = () => {
		Axios.get(baseApiUrl + "job/candidates/job/list?jobId=" + jobId).then(async (res) => {
	...
	const statusChange = (statusVal) => {
		...
		Axios.put(baseApiUrl + "/job/candidates/status/called/update", formData).then((res) => {
	...
	const statusChangeInterviewSchedule = (statusVal) => {
		...
		Axios.put(baseApiUrl + "/job/candidates/status/update", formData).then((res) => {
			...
			render: (text, record) => (
				<div className="dropdown dropdown-action text-end">
					...
					<div className="dropdown-menu dropdown-menu-right">
						<div className="dropdown-item" style={{ display: "flex", flexDirection: "column", background: "#ffffff" }}>
							...
							{record && record.status == "Interview Called" && (
								<a
									onClick={() => {
										setSelectedCandId(record.id);
							...
							{record && record.status == "Interview Scheduled" && (
								<a
									onClick={() => {
										setSelectedCandId(record.id);
							...
							{record && record.status == "Short Listed" && (
								<a
									onClick={() => {
										setSelectedCandId(record.id);
							...
							{record && record.status == "Called For Offer" && (
								<a
									onClick={() => {
										setSelectedCandId(record.id);
							...
							{record && record.status == "Offer Sent" && (
								<a
									onClick={() => {
										setSelectedCandId(record.id);
							...
							{record && record.status == "Offer Accepted" && (
								<a
									onClick={() => {
										setSelectedCandId(record.id);
                ...
                <i className="fa fa-clock-o m-r-5" data-bs-toggle="modal"
                  data-bs-target='#Employee_Form'>Employee Record</i>
					...
					<ActionForm
						submitForm={statusChangeInterviewSchedule}
						...
						confirmYes={statusChange}
						setInterviewDate={setInterviewDate}
						setOffer={setOffer}
						selectedType={selectedType}
						setInterviewTime={setInterviewTime}
						setInterviewDesc={setInterviewDesc}
					/>
					{/* <div className="dropdown-menu dropdown-menu-right">
            <div className="dropdown-item" style={{ display: "flex", flexDirection: "column", background: "#ffffff", }}>
              <Link to="/">
	...
	return (
		<div className="page-wrapper">
			<Helmet>
				<title>Jobs Applicants - Sheranwala Group</title>
											...
											<div className="row">
												...
												<div className="col-sm-6">
													<div className="form-group">
														...
														/>
														<span className="error">{errors.branch && touched.branch && errors.branch}</span>
													</div>
												</div>
												<div className="col-sm-6">
													<div className="form-group">
												...
												<div className="col-sm-6">
													<div className="form-group">
														<label className="col-form-label">Martial Status *</label>
														<br />
														<input
												...
												<span className="text-lg border-bottom border-2 border-dark mb-3">Employee Job Details: </span>
												<div className="col-sm-6">
													<div className="form-group">
												...
												<div className="col-sm-6">
													<div className="form-group">
														<label className="col-form-label">Current Designation *</label>

														<Field as="select" className="form-control" name="designation">
															<option value="">-</option>
															{designations &&
																designations.map((item) => <option value={item.id}>{item.title}</option>)}
														</Field>
												...
												<div className="col-sm-6">
													<div className="form-group">
														...
														<Field as="select" className="form-control" name="departments">
															<option value="">-</option>
												...
												<div className="col-sm-6">
													<div className="form-group">
														...
														<span className="error">
															{errors.dateOfJoining && touched.dateOfJoining && errors.dateOfJoining}
														</span>
													</div>
												</div>
												<div className="col-sm-6">
													<div className="form-group">
														...
														/>
														<span className="error">
															{errors.basicSalary && touched.basicSalary && errors.basicSalary}
														</span>
													</div>
												</div>
												<span className="text-lg border-bottom border-2 border-dark mb-3">
