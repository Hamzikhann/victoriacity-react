                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        ...
                                                        <Select placeholder="Select Member" options={memberList}
                                                            onChange={(value) => {
                                                                setFieldValue("MEMBER_ID", value)
                                                            }}
                                                        />
                                                        <span className="error">
                                                            {errors.MEMBER_ID && touched.MEMBER_ID && errors.MEMBER_ID}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div className="col-sm-6">
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control" type="text" placeholder='Nominee Name'
                                                            onChange={(e) => {
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="form-group">
                                                        <label>S/O, D/O, W/O <span className="text-danger">*</span></label>
                                                        <input className="form-control" type="text" placeholder='Father Name'
                                                            onChange={(e) => {
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="form-group">
                                                        <label>Select Relation <span className="text-danger">*</span></label>
                                                        <Select placeholder="Select Relation" options={options}
                                                            onChange={(value) => {
                                                ...
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        <label>Relation To Owner <span className="text-danger">*</span></label>
                                                        <input className="form-control" type="text" placeholder='Realtion To Owner'
                                                            onChange={(e) => {
                                ...
                                onSubmit={async (values, {setSubmitting}) => {
                                    ...
                                    try {
                                        ...
                                        const res = await Axios.put(
                                            baseApiUrl + `nominee/update?id=${query}`,
                                            formData
                                        );
                                        if (res.data.status == 200) {
                                            getAllNominee(1);
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        <label>Member <span className="text-danger">*</span></label>
                                                        <Select placeholder="Select Member" options={memberList} value={values.MEMBER_ID}
                                                            onChange={(value) => {
                                                                setFieldValue("MEMBER_ID", value)
                                                            }}
                                                        />
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="form-group">
                                                        <label>Nominee Name <span className="text-danger">*</span></label>
                                                        <input className="form-control" type="text" placeholder='Nominee Name' value={values.NomineeName}
                                                            onChange={(e) => {
                                                                setFieldValue("NomineeName", e.target.value);
                                                            }}
                                                        />
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="form-group">
                                                        <label>Nominee CNIC <span className="text-danger">*</span></label>
                                                        <InputMask
                                                            className="form-control"
                                                            mask="99999-9999999-9"
                                                            maskChar=" "
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="form-group">
                                                        <label>S/O, D/O, W/O <span className="text-danger">*</span></label>
                                                        <input className="form-control" type="text" placeholder='Father Name' value={values.NomineeFatherName}
                                                            onChange={(e) => {
                                                                setFieldValue("NomineeFatherName", e.target.value);
                                                            }}
                                                        />
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="form-group">
                                                        <label>Select Relation <span className="text-danger">*</span></label>
                                                        <Select placeholder="Select Relation" options={options} value={values.NomineeRealtion}
                                                            onChange={(value) => {
                                                                setFieldValue("NomineeRealtion", value)
                                                ...
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        <label>Relation To Owner <span className="text-danger">*</span></label>
                                                        <input className="form-control" type="text" placeholder='Realtion To Owner' value={values.RelationToOwner}
                                                            onChange={(e) => {
                                                                setFieldValue("RelationToOwner", e.target.value);
                                                            }}
                                                        />
                    ...
                    <div className="modal-content">
                        <div className="modal-body">
                            ...
                            <div className="modal-btn delete-action">
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal" type='submit' onClick={() => deleteNomineeById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
