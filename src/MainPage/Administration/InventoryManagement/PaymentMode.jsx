...
const PaymentMode = () => {
	...
	const getAllPaymentMode = () => {
		Axios.get(baseApiUrl + "paymentMode/list").then((res) => {
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.post(baseApiUrl + "paymentMode/add", formData);
									if (res.data.status == 200) {
										getAllPaymentMode();
										toast.success(res.data.message);
										setloading(false);
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.put(baseApiUrl + `paymentMode/update?id=${query}`, formData);
									if (res.data.status == 200) {
										getAllPaymentMode();
										toast.success(res.data.message);
										setloading(false);
								...
								<div className="row">
									<div className="col-6">
										<button
											...
											type="submit"
											onClick={() => deletePaymentModeById(query)}
										>
											Delete
										</button>
									</div>
