    ...
    const getAllsector = () => {
        Axios.get(baseApiUrl + "sector/list").then((res) => {
          res.data?.Sectors?.map((item) => {
            setSector((prev) => [
              ...prev,
              { label: item.NAME, value: item.SECT_ID },
            ]);
          });
        });
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="text" placeholder='Block Name' 
                                                           onChange={(e) => {
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <Select  type="text" placeholder='Sector Name' 
                                                    options={sector}
                                                           onChange={(value) => {
                                                    ...
                                                    />
                                                    <span className="error">
                                                            {errors.SECT_ID && touched.SECT_ID && errors.SECT_ID}
                                                        </span>
                                                </div>
                                            </div>
                                            <div className="col-sm-12">
                            ...
                            onSubmit={async (values, {setSubmitting}) => {
                                ...
                                try {
                                    ...
                                    const res = await Axios.put(
                                        baseApiUrl + `block/update?id=${query}`,
                                        formData
                                    );
                                    if (res.data.status == 200) {
                                        getAllBlock();
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="text" value={values.Name} placeholder='Block Name'
                                                           onChange={(e) => {
                                                               setFieldValue("Name", e.target.value);
                                                           }}
                                                    />
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <Select  type="text" value={values?.SECT_ID} placeholder='sector Name'
                                                    options={sector}
                                                           onChange={(value) => {
                                                               setFieldValue("SECT_ID", value);
                                                           }}
                                ...
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal"
                                                type='submit' onClick={() => deleteBlockById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
