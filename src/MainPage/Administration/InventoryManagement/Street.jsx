...
const Street = () => {
	...
	const getAllStreet = () => {
		Axios.get(baseApiUrl + "street/list").then((res) => {
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.post(baseApiUrl + "street/add", formData);
									if (res.data.status == 200) {
										getAllStreet();
										toast.success(res.data.message);
										setIsShowProjectModal(false);
										...
										<div className="row">
											<div className="col-sm-12">
												<div className="form-group">
													...
													/>
													<span className="error">{errors.ST_Code && touched.ST_Code && errors.ST_Code}</span>
												</div>
											</div>
											<div className="col-sm-12">
												<div className="form-group">
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.put(baseApiUrl + `street/update?id=${query}`, formData);
									if (res.data.status == 200) {
										getAllStreet();
										toast.success(res.data.message);
										setIsShowEditProjectModal(false);
								...
								<div className="row">
									<div className="col-6">
										<button
											...
											type="submit"
											onClick={() => deleteStreetById(query)}
										>
											Delete
										</button>
									</div>
