...
const NdcCharges = () => {
  ...
  const [isShowEditNdcChargesModal, setIsShowEditNdcChargesModal] =
    useState(false);
          ...
          <div className="row align-items-center">
            ...
            <div className="col-auto float-end ml-auto">
              <p
                ...
                onClick={() => setIsShowNdcChargesModal(true)}
              >
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                try {
                  ...
                  const res = await Axios.put(
                    baseApiUrl + `ndcCharges/update?id=${query}`,
                    formData
                  );
                  if (res.data.status == 200) {
                    getAllNdcCharges();
