                            ...
                            onSubmit={async (values, {setSubmitting}) => {
                                ...
                                try {
                                    ...
                                    const res = await Axios.put(
                                        baseApiUrl + `phase/update?id=${query}`,
                                        formData
                                    );
                                    if (res.data.status == 200) {
                                        getAllPhase();
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="text" value={values.NAME} placeholder='Phase Name'
                                                           onChange={(e) => {
                                                               setFieldValue("NAME", e.target.value);
                                                           }}
                                                    />
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <Select placeholder="Select IsActive" value={values.IsActive} options={options}
                                                            onChange={(value) => {
                                                                setFieldValue("IsActive", value)
                                ...
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal"
                                                type='submit' onClick={() => deletePhaseById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
