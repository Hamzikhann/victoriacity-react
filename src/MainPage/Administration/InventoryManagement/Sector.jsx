					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.post(baseApiUrl + "sector/add", formData);
									if (res.data.status == 200) {
										getAllSector();
										setloading(false);
										toast.success(res.data.message);
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.put(baseApiUrl + `sector/update?id=${query}`, formData);
									if (res.data.status == 200) {
										getAllSector();
										setloading(false);
										toast.success(res.data.message);
										...
										<div className="row">
											...
											<div className="col-sm-12">
												<div className="form-group">
													...
													{/*       }}*/}
													{/*/>*/}
													<span className="error">{errors.PHS_ID && touched.PHS_ID && errors.phase}</span>
												</div>
											</div>
											<div className="col-sm-12">
												<div className="form-group">
								...
								<div className="row">
									<div className="col-6">
										<button
											...
											type="submit"
											onClick={() => deleteSectorById(query)}
										>
											Delete
										</button>
									</div>
