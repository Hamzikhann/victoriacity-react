                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="text" placeholder='Unit Type'
                                                           onChange={(e) => {
                            ...
                            onSubmit={async (values, {setSubmitting}) => {
                                ...
                                try {
                                    ...
                                    const res = await Axios.put(
                                        baseApiUrl + `unitType/update?id=${query}`,
                                        formData
                                    );
                                    if (res.data.status == 200) {
                                        getAllUnitType();
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Unit Type <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" value={values.Name} placeholder='Unit Type'
                                                           onChange={(e) => {
                                                               setFieldValue("Name", e.target.value);
                                                           }}
                                                    />
                    ...
                    <div className="modal-content">
                        <div className="modal-body">
                            ...
                            <div className="modal-btn delete-action">
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal" type='submit' onClick={() => deleteUnitTypeById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
