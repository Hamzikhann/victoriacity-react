...
const PaymentPlan = () => {
	...
	const columns = [
		...
		},
		{
			...
			sorter: (a, b) => a.DC_NO_OF_INSTALLMENT.length - b.DC_NO_OF_INSTALLMENT.length
		},
		{
						...
						<Formik
							...
							validate={(values) => {
								...
								if (!values.TotalRemainNet_Amt) {
									errors.TotalRemainNet_Amt = "Total Remaining Net Amount is required";
								}
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								const res = await Axios.post(baseApiUrl + "package/add", formData);
								try {
									setloading(true);
									if (res.data.status == 200) {
										getAllPackages();
										...
										<div className="row">
											...
											<div className="col-sm-6">
												<div className="form-group">
													...
													/>
													<span className="error">{errors.Auto_Name && touched.Auto_Name && errors.Auto_Name}</span>
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													<label>
														Installment Start Date <span className="text-danger">*</span>
													</label>
													<input
														className="form-control"
														type="date"
													...
													<span className="error">
														{errors.INS_Start_Date && touched.INS_Start_Date && errors.INS_Start_Date}
													</span>
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													<label>
														DC START DATE <span className="text-danger">*</span>
													</label>
													<input
														className="form-control"
														type="date"
													...
													/>
													<span className="error">
														{errors.DC_START_DATE && touched.DC_START_DATE && errors.DC_START_DATE}
													</span>
												</div>
											</div>
											<div className="col-sm-6">
                              ...
                              errors.Type}
											...
											<div className="col-sm-6">
												<div className="form-group">
													...
													/>
													<span className="error">
														{errors.DC_TOTAL_AMOUNT && touched.DC_TOTAL_AMOUNT && errors.DC_TOTAL_AMOUNT}
													</span>
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													...
													/>
													<span className="error">
														{errors.Advance_Amt && touched.Advance_Amt && errors.Advance_Amt}
													</span>
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													<label>
														Total Remaining Net Amount <span className="text-danger">*</span>
													</label>
													<input
											...
											<div className="col-sm-6">
												<div className="form-group">
													<label>
														Annual Time Period <span className="text-danger">*</span>
													</label>
											...
											<div className="col-sm-6">
												<div className="form-group">
													<label>
														DC Installment Amount <span className="text-danger">*</span>
													</label>
													...
													<input
														...
														className="form-control"
														onChange={(e) => {
															setFieldValue("DC_INSTALLMENT_AMOUNT", e.target.value);
														}}
													/>
													<span className="error">
											...
											<div className="col-sm-6">
												<div className="form-group">
													<label>
														No of Installment <span className="text-danger">*</span>
													</label>
											...
											<div className="col-sm-6">
												<div className="form-group">
													<label>
														DC No Of installment <span className="text-danger">*</span>
													</label>
													...
													<input
														...
														className="form-control"
														onChange={(e) => {
															setFieldValue("DC_NO_OF_INSTALLMENT", e.target.value);
														}}
													/>
													<span className="error">
														{errors.DC_NO_OF_INSTALLMENT && touched.DC_NO_OF_INSTALLMENT && errors.DC_NO_OF_INSTALLMENT}
													</span>
												</div>
											</div>
											<div className="col-sm-6">
										...
										<div className="submit-section">
											{loading ? (
												...
												>
													<div class="spinner-border text-warning" role="ByAnnual_TimePeriod">
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.put(baseApiUrl + `package/update?id=${query}`, formData);
									if (res.data.status == 200) {
										getAllPackages();
										toast.success(res.data.message);
										setloading(false);
                            ...
                            {errors.Type &&
                              ...
                              errors.Type}
											...
											<div className="col-sm-6">
												<div className="form-group">
													<label>
														Advance Total Amount <span className="text-danger">*</span>
													</label>
													<input
