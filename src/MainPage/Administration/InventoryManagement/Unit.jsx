...
const Unit = () => {
              ...
              <Link
                ...
                onClick={() => {
                  ...
                  setUnitInitialValues({
                    ...
                    MeterRef_No: "",
                    ...text,
                    IsActive: statusList.find(
                      (item) => text.IsActive == item.value
                    ),
                    IsPossession: statusList.find(
                      (item) => text.IsPossession == item.value
                    ),
                    IsAvailable: status.find(
                      (item) => text.IsAvailable == item.value
                    ),
                    FL_ID: text?.Block
                      ? { label: text.Block.Name, value: text.Block.FL_ID }
                      : "",
                    CAT_ID: text?.Street
                      ? { label: text.Street.Name, value: text.Street.CAT_ID }
                      : "",
                    BK_ID: text?.Block
                      ? { label: text.Block.Name, value: text.Block.BK_ID }
                      : "",
                    ST_ID: text?.Street
                      ? { label: text.Street.Name, value: text.Street.ST_ID }
                      : "",
    ...
    Axios.get(baseApiUrl + "block/list")
      .then((res) => {
        res.data.Blocks.map((item) => {
          setBlockName((prev) => [
            ...prev,
            { label: item.Name, value: item.BLK_ID },
          ]);
        });
      })
      .catch((err) => console.log(err.response.data));
    ...
    Axios.get(baseApiUrl + "street/list")
      .then((res) => {
        res.data.Street.map((item) => {
          setStreetName((prev) => [
            ...prev,
            { label: item.Name, value: item.ST_ID },
          ]);
        });
      })
      .catch((err) => console.log(err.response.data));
    ...
    Axios.get(baseApiUrl + "floor/list")
      .then((res) => {
        res.data.floors.map((item) => {
          setFloorName((prev) => [
            ...prev,
            { label: item.Name, value: item.FL_ID },
          ]);
        });
      })
      .catch((err) => console.log(err.response.data));
    ...
    Axios.get(baseApiUrl + "unitCategory/list")
      .then((res) => {
        res.data.UnitCategorys.map((item) => {
          setUnitCategoryName((prev) => [
            ...prev,
            { label: item.CAT_Name, value: item.CAT_ID },
          ]);
        });
      })
      .catch((err) => console.log(err.response.data));
  ...
  const getFilterUnit = (PS_ID, UType_ID, BLK_ID) => {
    ...
    Axios.get(
      baseApiUrl +
        `/unit/filter?PS_ID=${PS_ID}&UType_ID=${UType_ID}&BLK_ID=${BLK_ID}`
    ).then((res) => {
          ...
          <div className="col-sm-3">
            <div className="form-group">
              <Select
                ...
                options={plotSize}
                onChange={(value) => setPSize(value.value)}
              />
            </div>
          </div>
          <div className="col-sm-3">
            <div className="form-group">
              <Select
                ...
                options={blockName}
                onChange={(value) => setBlock(value.value)}
              />
            </div>
          </div>
          <div className="col-sm-3">
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-6">
                        <div className="form-group">
                          ...
                          />
                          <span className="error">
                            {errors.BK_ID && touched.BK_ID && errors.BK_ID}
                          </span>
                        </div>
                      </div>
                      <div className="col-sm-6">
                        <div className="form-group">
                          ...
                          />
                          <span className="error">
                            {errors.ST_ID && touched.ST_ID && errors.ST_ID}
                          </span>
                        </div>
                      </div>
                      <div className="col-sm-6">
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                try {
                  ...
                  const res = await Axios.put(
                    baseApiUrl + `unit/update?id=${query}`,
                    formData
                  );
                  if (res.data.status == 200) {
                    getAllUnit();
            ...
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                try {
                  setloading(true);
                  const res = await Axios.put(
                    baseApiUrl + `/unit/update/vcno?id=${query}`,
                    formData
                  );
                  if (res.data.status == 200) {
                    getAllUnit(1);
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <div className="form-group">
                          ...
                          <span className="error">
                            {errors.VC_NO && touched.VC_NO && errors.VC_NO}
                          </span>
                        </div>
                      </div>
                    </div>
