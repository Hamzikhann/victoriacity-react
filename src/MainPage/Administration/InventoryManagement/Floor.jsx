                                ...
                                onSubmit={async (values, {setSubmitting}) => {
                                    ...
                                    try {
                                        ...
                                        const res = await Axios.put(
                                            baseApiUrl + `floor/update?id=${query}`,
                                            formData
                                        );
                                        if (res.data.status == 200) {
                                            getAllFloor();
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control" value={values.Name} type="text" placeholder='Name'
                                                            onChange={(e) => {
                                                                setFieldValue("Name", e.target.value);
                                                            }}
                                                        />
                                                ...
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control" value={values.Abbrev} type="text" placeholder='Abbreviation'
                                                            onChange={(e) => {
                                                                setFieldValue("Abbrev", e.target.value);
                                                            }}
                                                        />
                    ...
                    <div className="modal-content">
                        <div className="modal-body">
                            ...
                            <div className="modal-btn delete-action">
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal" type='submit' onClick={() => deleteFloorById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
