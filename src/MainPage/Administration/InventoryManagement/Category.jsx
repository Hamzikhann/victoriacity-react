					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.post(baseApiUrl + "unitCategory/add", formData);
									if (res.data.status == 200) {
										getAllUnitCategory();
										toast.success(res.data.message);
										setIsShowProjectModal(false);
										...
										<div className="row">
											<div className="col-sm-12">
												<div className="form-group">
													...
													/>
													<span className="error">{errors.CAT_Name && touched.CAT_Name && errors.CAT_Name}</span>
												</div>
											</div>
											<div className="col-sm-12">
												<div className="form-group">
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.put(baseApiUrl + `unitCategory/update?id=${query}`, formData);
									if (res.data.status == 200) {
										getAllUnitCategory();
										toast.success(res.data.message);
										setIsShowEditProjectModal(false);
								...
								<div className="row">
									<div className="col-6">
										<button
											...
											type="submit"
											onClick={() => deleteUnitCategoryById(query)}
										>
											Delete
										</button>
									</div>
