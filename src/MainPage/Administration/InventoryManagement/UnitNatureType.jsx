...
const UnitNatureType = () => {
    ...
    const getAllUnitNatureType = () => {
        Axios.get(baseApiUrl + "unitNatureType/list")
            .then((res) => {
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Unit Nature Type <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" placeholder='Unit Nature Type'
                                                           onChange={(e) => {
                            ...
                            onSubmit={async (values, {setSubmitting}) => {
                                ...
                                try {
                                    ...
                                    const res = await Axios.put(
                                        baseApiUrl + `unitNatureType/update?id=${query}`,
                                        formData
                                    );
                                    if (res.data.status == 200) {
                                        getAllUnitNatureType();
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Unit Nature Type <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" value={values.Name} placeholder='Unit Nature Type'
                                                           onChange={(e) => {
                                                               setFieldValue("Name", e.target.value);
                                                           }}
                                                    />
                                ...
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal"
                                                type='submit' onClick={() => deleteUnitNatureTypeById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
