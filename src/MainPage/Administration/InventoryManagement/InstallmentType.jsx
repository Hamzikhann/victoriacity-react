...
const InstallmentType = () => {
    ...
    const [installmentTypeInitialValues, setInstallmentTypeInitialValues] = useState({
        Name: "",
        Abbrev: "",
        Status: "",
    });
                    ...
                    <div className="dropdown dropdown-action text-end">
                        ...
                        <div className="dropdown-menu dropdown-menu-right">
                            <Link
                                ...
                                onClick={() => {
                                    setQuery(text.InsType_ID);
                                    setIsShowEditProjectModal(true);
                                    setInstallmentTypeInitialValues({
                                        Name: "",
                                        Abbrev: "",
                                        ...text,
    ...
    const getAllInstallmentType = () => {
        Axios.get(baseApiUrl + "installmentType/list")
            .then((res) => {
                setInstallmentType(res.data.InstallmentType);
                // console.log(res.data.Blocks)
            });
    };

    const deleteInstallmentTypeById = (id) => {
        Axios.delete(baseApiUrl + `installmentType/delete?id=${id}`)
            .then((res) => {
                if (res.data.status == 200) {
                    getAllInstallmentType();
    ...
    return (
        <div className="page-wrapper">
            ...
            />
            <Helmet>
                <title>Installment Type - HRMS Admin Template</title>
            ...
            <div className="content container-fluid">
                ...
                <div className="page-header">
                    <div className="row align-items-center">
                        <div className="col">
                            <h3 className="page-title">Installment Type</h3>
                            <ul className="breadcrumb">
                                <li className="breadcrumb-item"><Link to="/app/main/dashboard">Dashboard</Link></li>
                                <li className="breadcrumb-item active">Installment Type</li>
                            </ul>
                        </div>
                        <div className="col-auto float-end ml-auto">
                            ...
                            >
                                <i className="fa fa-plus"/> Create Installment Type
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <Modal show={isShowProjectModal}>
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Add Installment Type</h5>
                        <button
                            type="button"
                            className="close"
                            onClick={() => {
                    ...
                    <div className="modal-body">
                        <Formik
                            initialValues={installmentTypeInitialValues}
                            validate={(values) => {
                                const errors = {};
                                if (!values.Name) {
                            ...
                            onSubmit={async (values, {setSubmitting}) => {
                                ...
                                try {
                                    ...
                                    const res = await Axios.post(
                                        baseApiUrl + "installmentType/add",
                                        formData
                                    );
                                    if (res.data.status == 200) {
                                        getAllInstallmentType();
                                ...
                                return (
                                    <form onSubmit={handleSubmit}>
                                        <div className="row">
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Abbreviation <span className="text-danger">*</span></label>
            ...
            <Modal show={isShowEditProjectModal}>
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit Installment Type</h5>
                        <button
                            type="button"
                            className="close"
                            onClick={() => {
                            ...
                            onSubmit={async (values, {setSubmitting}) => {
                                ...
                                try {
                                    ...
                                    const res = await Axios.put(
                                        baseApiUrl + `installmentType/update?id=${query}`,
                                        formData
                                    );
                                    if (res.data.status == 200) {
                                        getAllInstallmentType();
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Name <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" value={values.Name} placeholder='Name'
                                                           onChange={(e) => {
                                                               setFieldValue("Name", e.target.value);
                                                           }}
                                                    />
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Abbreviation <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" value={values.Abbrev} placeholder='Abbreviation'
                                                           onChange={(e) => {
                                                               setFieldValue("Abbrev", e.target.value);
                                                           }}
                                                    />
                                ...
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal"
                                                type='submit' onClick={() => deleteInstallmentTypeById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
