...
const InstallmentType = () => {
	...
	const getAllInstallmentType = () => {
		Axios.get(baseApiUrl + "installmentType/list").then((res) => {
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.post(baseApiUrl + "installmentType/add", formData);
									if (res.data.status == 200) {
										getAllInstallmentType();
										toast.success(res.data.message);
										setloading(false);
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.put(baseApiUrl + `installmentType/update?id=${query}`, formData);
									if (res.data.status == 200) {
										getAllInstallmentType();
										toast.success(res.data.message);
										setloading(false);
								...
								<div className="row">
									<div className="col-6">
										<button
											...
											type="submit"
											onClick={() => deleteInstallmentTypeById(query)}
										>
											Delete
										</button>
									</div>
