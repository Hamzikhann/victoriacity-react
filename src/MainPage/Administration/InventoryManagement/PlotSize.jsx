                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Plot Name <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" placeholder='Plot Name'
                                                           onChange={(e) => {
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Marla Size <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" placeholder='Marla Size'
                                                           onChange={(e) => {
                                                               setFieldValue("Size_Marla", e.target.value);
                                                           }}
                                                    />
                                                    <span className="error">
                                                            {errors.Size_Marla && touched.Size_Marla && errors.Size_Marla}
                                                        </span>
                                                </div>
                                            </div>
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Square Feet Size <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" placeholder='Square Feet Size'
                                                           onChange={(e) => {
                                                               setFieldValue("Size_SQF", e.target.value);
                                                           }}
                                                    />
                                                    <span className="error">
                                                            {errors.Size_SQF && touched.Size_SQF && errors.Size_SQF}
                                                        </span>
                                                </div>
                                            </div>
                                            <div className="col-sm-12">
                            ...
                            onSubmit={async (values, {setSubmitting}) => {
                                ...
                                try {
                                    ...
                                    const res = await Axios.put(
                                        baseApiUrl + `plotSize/update?id=${query}`,
                                        formData
                                    );
                                    if (res.data.status == 200) {
                                        getAllPlot();
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Plot Name <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" value={values.Name} placeholder='Plot Name'
                                                           onChange={(e) => {
                                                               setFieldValue("Name", e.target.value);
                                                           }}
                                                    />
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Size Marla <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" value={values.Size_Marla} placeholder='Marla Size'
                                                           onChange={(e) => {
                                                               setFieldValue("Size_Marla", e.target.value);
                                                           }}
                                                    />
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    <label>Square Feet Size <span className="text-danger">*</span></label>
                                                    <input className="form-control" type="text" value={values.Size_SQF} placeholder='Square Feet Size'
                                                           onChange={(e) => {
                                                               setFieldValue("Size_SQF", e.target.value);
                                                           }}
                                                    />
                                ...
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal"
                                                type='submit' onClick={() => deletePlotById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
