                ...
                <div className="profile-view">
                  <div className="profile-img-wrap">
                    <div className="profile-img">
                      <a href="#"><img className="w-100 h-100 avatar" alt="" src={employee?.image} onError={({ currentTarget }) => {
                      ...
                      <div className="col-md-7">
                        <ul className="personal-info">
                          <li>
                            ...
                            <div className="text"><a href="">{employee?.contact}</a></div>
                          </li>
                          <li>
          ...
          <div id="emp_profile" className="pro-overview tab-pane fade show active">
            ...
            <div className="row">
              ...
              <div className="col-md-6 d-flex">
                <div className="card profile-box flex-fill">
                  <div className="card-body">
                    <h3 className="card-title">Assets <a href="#" className="edit-icon" data-bs-toggle="modal" data-bs-target="#add_assets_modal"><i className="fa fa-pencil" /></a></h3>
                    <div className="table-responsive">
                      <table className="table table-nowrap">
                        <thead>
                          <tr>
              ...
              <div className="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                <div className="card">
                  <div className="card-body">
                    ...
                    <h4 className="project-title"><Link to={`/app/projects/projects-view?id=${query.get("id")}`}>
                          ...
                          <div className="row">
                            <div className="col-md-6">
                              <div className="form-group">
                                <label>Phone</label>
                                <input className="form-control" value={values.contact} type="text" placeholder='Phone Number'
                                  onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                <label>Email</label>
                                <div>
                                  <input className="form-control" value={values.email} type="email" onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                ...
                                <div>
                                  <input className="form-control datetimepicker" value={values.dob} type="date" onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                <label>Address</label>
                                <input type="text" value={values.address} className="form-control" placeholder='Address'
                                  onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                <label>Gender</label>
                                <div>
                                  <input className="form-control" value={values.gender} type="text" placeholder='Gender'
                                    onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                ...
                                <div>
                                  <input className="form-control" value={values.maritalStatus} type="text" placeholder='Marital Status'
                                    onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                ...
                                <div>
                                  <input className="form-control" value={values.emergencyContactName} type="text" placeholder='Emergency Contact Name'
                                    onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                ...
                                <div>
                                  <input className="form-control" value={values.emergencyContactNumber} type="text" placeholder='Emergency Contact Number'
                                    onChange={(e) => {
                            ...
                            <div className="col-md-6">
                              <div className="form-group">
                                ...
                                <div>
                                  <input className="form-control" value={values.relationship} type="text" placeholder='Relationship'
                                    onChange={(e) => {
                          ...
                          <div className="card-body">
                            ...
                            <div className="row">
                              <div className="col-md-6">
                                <div className="form-group">
                                  <label>Name <span className="text-danger">*</span></label>
                                  <input className="form-control" value={values.name} type="text"
                                    onChange={(e) => {
                                      setFieldValue("name", e.target.value);
                                    }}
                                  />
                              ...
                              <div className="col-md-6">
                                <div className="form-group">
                                  <label>Relationship <span className="text-danger">*</span></label>
                                  <input className="form-control" type="text" value={values.relation}
                                    onChange={(e) => {
                                      setFieldValue("relation", e.target.value);
                                    }}
                                  />
                              ...
                              <div className="col-md-6">
                                <div className="form-group">
                                  <label>Date of birth <span className="text-danger">*</span></label>
                                  <input className="form-control" type="text" value={values.dob}
                                    onChange={(e) => {
                                      setFieldValue("dob", e.target.value);
                                    }}
                                  />
                              ...
                              <div className="col-md-6">
                                <div className="form-group">
                                  <label>Phone <span className="text-danger">*</span></label>
                                  <input className="form-control" type="text" value={values.contact}
                                    onChange={(e) => {
                                      setFieldValue("contact", e.target.value);
                                    }}
                                  />
          ...
          <div className="modal-content">
            <div className="modal-body">
              ...
              <div className="modal-btn delete-action">
                <div className="row">
                  <div className="col-6">
                    <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal" type='submit' onClick={() => deleteEmployeeRelationById(query.get("id"))}>
                      Delete
                    </button>
                  </div>
                  <div className="col-6">
                ...
                {({
                  ...
                  return (
                    <form >
                      ...
                      <div className="form-group">
                        <label>Select Asset <span className="text-danger">*</span></label>
                        ...
                        <div className="card">
                          <div className="card-body">
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-6">
                                <div className="form-group">
                                  <label>Added Date <span className="text-danger">*</span></label>
                                  <input className="form-control" type="text"
                                    onChange={(e) => {
          ...
          <div className="modal-content">
            <div className="modal-body">
              ...
              <div className="modal-btn delete-action">
                <div className="row">
                  <div className="col-6">
                    <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal" type='submit' onClick={() => deleteAssetsById(query.get("id"))}>
                      Delete
                    </button>
                  </div>
                  <div className="col-6">
