...
const Tasks = () => {
	...
	const getAllTaskById = () => {
		Axios.get(baseApiUrl + `projectTask/id/list?id=${query}`).then((res) => {
									...
									<div className="float-start me-auto">
										<div className="add-task-btn-wrapper">
											<span
												...
												className={`" ${
													task ? "add-task-btn btn btn-white btn-sm" : "add-task-btn btn btn-white btn-sm visible"
												}`}
											>
												Add Task
											</span>
																			...
																			<div className="task-container">
																				<span className="task-action-btn task-check">
																					<span
																						className={`action-circle large complete-btn  ${
																							task?.id === selected?.id ? "bg-success" : " "
																						}`}
																					>
																						<i
																							className={`material-icons ${
																								task?.id === selected?.id ? "text-light" : " "
																							}`}
																				...
																				<span className="task-action-btn task-btn-right">
																					...
																					<span className="action-circle large delete-btn" title="Delete Task">
																						<i className="material-icons" onClick={() => taskRemove(task.id)}>
																							delete
																						</i>
																					</span>
																				</span>
											...
											<div className="chats">
													...
													<div className="assignee-info">
														<a href="#" data-bs-toggle="modal" data-bs-target="#assi  kgnee">
															...
															<div className="assigned-info">
																...
																<div className="task-assignee">{taskById?.employee?.fullName}</div>
															</div>
														</a>
													...
													<div className="task-due-date">
														<a href="#" data-bs-toggle="modal" data-bs-target="#assi  kgnee">
															...
															<div className="due-info">
																...
																<div className="due-date">{taskById?.dueDate}</div>
															</div>
														</a>
														{/*<span className="remove-icon">*/}
														{/*    <i className="fa fa-close" />*/}
												...
												<div className="task-desc">
													...
													<div className="assigned-info w-100">
														...
														<div className="form-control h-auto">{taskById?.description}</div>
													</div>
												</div>
											</div>
										</div>
					...
					<div className="modal-body">
						<Formik
							...
							onSubmit={async (values, { setSubmitting }) => {
								...
								try {
									setloading(true);
									const res = await Axios.post(baseApiUrl + "projectTask/add", formData);
									if (res.data.status == 200) {
										getAllTasks();
										setloading(false);
										toast.success(res.data.message);
										...
										<div className="row">
											...
											<div className="col-sm-12">
												<div className="form-group">
													...
													/>
													<span className="error">{errors.dueDate && touched.dueDate && errors.dueDate}</span>
												</div>
											</div>
											<div className="col-sm-12">
												<div className="form-group">
													...
													{/*       }}*/}
													{/*/>*/}
													<span className="error">{errors.assignedTo && touched.assignedTo && errors.assignedTo}</span>
												</div>
											</div>
											<div className="col-sm-12">
												<div className="form-group">
