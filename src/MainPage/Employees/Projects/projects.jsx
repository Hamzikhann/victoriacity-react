		...
		<div className="page-wrapper">
            ...
            <div className="form-group">
              ...
              //  <label className="focus-label">Employee Name</label>
					...
					<div className="col-sm-6 col-md-4">
						<div className="form-group">
							<Select placeholder="Status" options={statusOptions} onChange={(event) => handleStatusChange(event)} />
							{/* <label className="focus-label">Designation</label> */}
						</div>
					</div>
					...
					{filteredProjects &&
                          ...
                          >
                            <i className="fa fa-pencil m-r-5" /> Edit
												...
												<h4 className="project-title">
													<Link to={`/app/projects/projects-view?id=${project.id}`}>{project.name}</Link>
												</h4>
                        ...
                        <span className="text-muted">tasks completed</span>
												...
												<div className="pro-deadline m-b-15">
													...
													<div className="text-muted">{project.startDate + " - " + project.endDate}</div>
												</div>
