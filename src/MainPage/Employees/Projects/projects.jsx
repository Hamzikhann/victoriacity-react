...
const Projects = () => {
    ...
    const priorityOptions = [{value: "0", label: "None"}
        ,
    ...
    const handlePriorityChange = (event) => {
        if (event.value === "high") {
            ...
            setFilteredProjects(
                projects.filter((item) => item.priority === "medium")
            );
    ...
    const handleStatusChange = (event) => {
        if (event.value === "Active") {
            ...
            setFilteredProjects(
                projects.filter((item) => item.status === "InActive")
            );
        } else {
            setFilteredProjects(projects);
        }
        ...
        <div className="page-wrapper">
            ...
            <div className="content container-fluid">
                ...
                <div className="row filter-row ">
                    ...
                    {/* <div className="col-sm-6 col-md-4">
            <div className="form-group">
              <input type="text" placeholder="Periority" className="form-control" />
                          ...
                          >
                            <i className="fa fa-pencil m-r-5" /> Edit
                                                ...
                                                <h4 className="project-title">
                                                    <Link
                                                        to={`/app/projects/projects-view?id=${project.id}`}
                                                    >
                                                        {project.name}
                                                    </Link>
                                                </h4>
                                    ...
                                    <div className="row">
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                ...
                                                <Select placeholder="Select Priority" options={pOptions}
                                                        onChange={(value) => {
                              ...
                              errors.priority}
                                        ...
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                ...
                                                <Select placeholder="Select Status" options={sOptions}
                                                        onChange={(value) => {
