                                    ...
                                    onSubmit={async (values, {setSubmitting}) => {
                                        ...
                                        try {
                                            ...
                                            const res = await Axios.put(
                                                baseApiUrl +`leave/status/update?id=${query}`,
                                                formData
                                            );
                                            if (res.data.status == 200) {
                                                getAllLeave();
                                ...
                                >
                                                ...
                                                <div className="row">
                                                    <div className="col-md-12">
                                                        <div className="form-group">
                                                            ...
                                                            <Select placeholder="Select Status" value={values.status}
                                                                    options={options}
                                                                    onChange={(value) => {
                                  ...
                                  {errors.status}
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <input className="form-control" type="text" value={values.comment}
                                                                   placeholder='Comment'
                                                                   onChange={(e) => {
