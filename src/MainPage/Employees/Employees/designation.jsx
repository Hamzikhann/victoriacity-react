                ...
                return (
                    <div className="dropdown dropdown-action text-end">
                        <Link to="/" className="action-icon dropdown-toggle" data-bs-toggle="dropdown"
                              aria-expanded="false"><i className="material-icons">more_vert</i></Link>
                        <div className="dropdown-menu dropdown-menu-right">
                            <Link
                                to="/" className="dropdown-item" data-bs-toggle="modal"
                                ...
                                onSubmit={async (values, {setSubmitting}) => {
                                    ...
                                    try {
                                        ...
                                        const res = await Axios.post(
                                            baseApiUrl + "designation/add", formData
                                        );
                                        if (res.data.status == 200) {
                                            getAllDesignation();
                                            setloading(false);
                                ...
                                onSubmit={async (values, {setSubmitting}) => {
                                    ...
                                    try {
                                        ...
                                        const res = await Axios.put(
                                            baseApiUrl + `designation/update?id=${query}`,
                                            formData
                                        );
                                        if (res.data.status == 200) {
                                            getAllDesignation();
                                ...
                                {({
                                    ...
                                    return (
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <div className="form-group">
                                                <label>Status <span className="text-danger">*</span></label>
                                                <Select placeholder="Select Status" value={options.find(item => item.value === values.status)} options={options}
                                                        onChange={(value) => {
                                                            setFieldValue("status", value)
                                    ...
                                    <div className="row">
                                        <div className="col-6">
                                            <Link to="/" className="btn btn-primary continue-btn"
                                                  ...
                                                  onClick={() => deleteDesignationById(query)}>Delete</Link>
                                        </div>
                                        <div className="col-6">
