        ...
        },
        {
            ...
            render: (text, record) => (
                <div className="dropdown dropdown-action text-end">
                    <a href="#" className="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i
                        className="material-icons">more_vert</i></a>
                    <div className="dropdown-menu dropdown-menu-right">
                        <Link to="/" className="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit_department"
                              onClick={() => {
                                  setQuery(text.id);
                        ...
                        <Link to="/" className="dropdown-item" data-bs-toggle="modal"
                              data-bs-target="#delete_department"
                              onClick={() => {
                                  setQuery(text.id)
                              }}><i className="fa fa-trash-o m-r-5"/> Delete</Link>
                    </div>
                </div>
            ),
        },
                                    ...
                                    onSubmit={async (values, {setSubmitting}) => {
                                        ...
                                        try {
                                            ...
                                            const res = await Axios.post(
                                                baseApiUrl + "department/add", formData
                                            );
                                            if (res.data.status == 200) {
                                                getAllDepartment();
                                                setloading(false);
                                    ...
                                    onSubmit={async (values, {setSubmitting}) => {
                                        ...
                                        try {
                                            ...
                                            const res = await Axios.put(
                                                baseApiUrl +`department/update?id=${query}`,
                                                formData
                                            );
                                            if (res.data.status == 200) {
                                                getAllDepartment();
                                        ...
                                        return (
                                            <form onSubmit={handleSubmit}>
                                                <div className="form-group">
                                                    <label>Department Name <span
                                                        className="text-danger">*</span></label>
                                                    <input className="form-control" value={values.title} type="text"
                                                           placeholder='Department Name'
                                                           onChange={(e) => {
                                                               setFieldValue("title", e.target.value);
                                                           }}
                                    ...
                                    <div className="row">
                                        <div className="col-6">
                                            <Link to="/" className="btn btn-primary continue-btn"
                                                  ...
                                                  onClick={() => deleteDepartmentById(query)}>Delete</Link>
                                        </div>
                                        <div className="col-6">
                                            <Link to="/" data-bs-dismiss="modal"
                                                  className="btn btn-primary cancel-btn">Cancel</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
