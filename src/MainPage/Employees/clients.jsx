        ...
        <div className="row staff-grid-row">
          {customers?.map((cust, i) => (
              <>
                <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                  <div className="profile-widget">
                    <div className="profile-img">
                      <Link
                        to={`/app/profile/client-profile/${cust.id}`}
                        className="avatar"
                      >
                        <img alt="" src={cust.image} onError={({ currentTarget }) => {
                    ...
                    <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                      <Link to={`/app/profile/client-profile/${cust?.id}`}>
                        {cust?.companyName}
                      </Link>
                    </h4>
                ...
                {/* Edit Client Modal */}
                <Editclient cust={cust} setIsShowEditModal={setIsShowEditModal} isShowEditModal={isShowEditModal} getAllCustomers={getAllCustomers} forEdit={forEdit}/>
                {/* /Edit Client Modal */}
              </>
            ))}
        </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-6">
                      <div className="form-group">
                        ...
                        <Select placeholder="Select Gender" isSearchable={false} options={genderOptions}
                                onChange={(value) => {
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <Select placeholder="Select Designation" options={designations?.map((item) => {
                          return {
                            value: item.id,
                            label: item.title
                          }
