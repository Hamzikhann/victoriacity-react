...
const Policies = () => {
    ...
    const getAllPolicy = () => {
        Axios.get(baseApiUrl + "policy/list")
            .then((res) => {
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="text" placeholder='Policy Name'
                                                           onChange={(e) => {
                            ...
                            onSubmit={async (values, {setSubmitting}) => {
                                ...
                                try {
                                    ...
                                    const res = await Axios.put(
                                        baseApiUrl + `policy/update?id=${query}`,
                                        formData
                                    );
                                    if (res.data.status == 200) {
                                        getAllPolicy();
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="text" placeholder='Policy Name' value={values.title}
                                                           onChange={(e) => {
                                                               setFieldValue("title", e.target.value);
                                                           }}
                                                    />
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="text" placeholder='Description' value={values.description}
                                                           onChange={(e) => {
                                                               setFieldValue("description", e.target.value);
                                                           }}
                                                    />
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="date" placeholder='Start Date' value={values.startDate}
                                                           onChange={(e) => {
                                                               setFieldValue("startDate", e.target.value);
                                                           }}
                                                    />
                                            ...
                                            <div className="col-sm-12">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="date" placeholder='End Date' value={values.endDate}
                                                           onChange={(e) => {
                                                               setFieldValue("endDate", e.target.value);
                                                           }}
                                                    />
                                ...
                                <div className="row">
                                    <div className="col-6">
                                        <button className="btn btn-primary w-100 continue-btn" data-bs-dismiss="modal"
                                                type='submit' onClick={() => deletePolicyById(query)}>
                                            Delete
                                        </button>
                                    </div>
                                    <div className="col-6">
