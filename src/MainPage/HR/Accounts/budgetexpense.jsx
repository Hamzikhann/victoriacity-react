                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        ...
                                                        <DropdownTreeSelect data={treeData} onAction={onAction} onNodeToggle={onNodeToggle} className="w-100"
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className="form-group form-row">
                                    <label className="col-lg-12 control-label">Amount <span
                                ...
                                <div className="form-group form-row">
                                    <label className="col-lg-12 control-label">Notes <span
                                        className="text-danger">*</span></label>
                                ...
                                <div className="form-group form-row">
                                    <label className="col-lg-12 control-label">Expense Date <span
                                        className="text-danger">*</span></label>
                                    <div className="col-lg-12">
                                        <input className="datepicker-input form-control" type="text"
                                               defaultValue="07-05-2021" name="expense_date"
                                               data-date-format="dd-mm-yyyy"/>
                                    </div>
                                </div>
                                <div className="form-group form-row">
                                    <label className="col-lg-12 control-label">Category <span
                                        className="text-danger">*</span></label>
                                    <div className="col-lg-12">
                                ...
                                <div className="form-group form-row">
                                    <label className="col-lg-12 control-label">Sub Category <span
                                        className="text-danger">*</span></label>
                                    <div className="col-lg-12">
                                ...
                                <div className="form-group form-row  position-relative">
                                    ...
                                    <div className="col-lg-12">
                                        <input type="file" className="form-control" data-buttontext="Choose File"
